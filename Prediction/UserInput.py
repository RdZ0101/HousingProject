...
def predict_price(postcode, rooms, property_type, landsize=None):#, price_per_room=None, price_per_landsize=None):
...
# Predict the price
predicted_price = predict_price(postcode, rooms, property_type, landsize)#, price_per_room, price_per_landsize)
